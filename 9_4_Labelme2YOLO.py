...
def process_single_json(labelme_path, save_folder='/home/c/桌面/Ruler_15_Dataset/labels/train'):
...
save_folder = '/home/c/桌面/Ruler_15_Dataset/labels/train'
...
os.chdir('/home/c/桌面/Ruler_15_Dataset/labelme_jsons/val')
save_folder = '/home/c/桌面/Ruler_15_Dataset/labels/val'
for labelme_path in os.listdir():
    process_single_json(labelme_path, save_folder=save_folder)
print('YOLO格式的txt标注文件已保存至 ', save_folder)
